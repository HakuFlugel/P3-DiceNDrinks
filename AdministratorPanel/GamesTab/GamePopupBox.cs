...
namespace AdministratorPanel {
    ...
    public class GamePopupBox : FancyPopupBox {
        ...
        private void SubscriptionList() {
             ...
             */
            yearPublishedBox.TextChanged += (s, e) => { hasBeenChanged = (isNewGame) ? ((beforeEditing.publishedYear.ToString() != yearPublishedBox.Text) ? true : false) : true; };
            ...
            playerBox.TextChanged += (s, e) => { hasBeenChanged = (isNewGame) ? (!((beforeEditing.minPlayers.ToString() + "/" + beforeEditing.maxPlayers.ToString()).Equals(playerBox.Text)) ? true : false) : false; };
